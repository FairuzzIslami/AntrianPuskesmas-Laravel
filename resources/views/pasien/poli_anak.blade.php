...
@section('title', 'Status Antrian - Poli Anak')
                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="text-light mb-0">Status antrian Anda di Poli Anak akan diperbarui secara real-time</p>
                        </div>
            ...
            <div class="card border-0 shadow-lg rounded-4 mb-4">
                <div class="card-body p-5 text-center">
                    <div class="bg-primary bg-opacity-10 rounded-circle mx-auto d-flex align-items-center justify-content-center mb-4" style="width: 100px; height: 100px;">
                        <i class="fas fa-baby text-primary fs-1"></i>
                    </div>
                    ...
                    @if($antrianAktif)
                        @if($antrianAktif->status == 'dipanggil')
                            ...
                            <div class="display-1 fw-bold text-gradient mb-3" style="color: #4e73df;">K-{{ str_pad($antrianAktif->nomor_antrian, 3, '0', STR_PAD_LEFT) }}</div>
                            <p class="text-muted mb-4">Silakan menuju ke ruangan Poli Anak</p>
                        ...
                        @elseif($antrianAktif->status == 'menunggu')
                            ...
                            <div class="display-1 fw-bold text-gradient mb-3" style="color: #f6c23e;">K-{{ str_pad($antrianAktif->nomor_antrian, 3, '0', STR_PAD_LEFT) }}</div>
                            <p class="text-muted mb-4">Perkiraan waktu tunggu: 10-15 menit</p>

                            <div class="waiting-info bg-light rounded-3 p-4">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-muted">Antrian Saat Ini</span>
                                    <span class="badge bg-primary fs-6">
                                        {{ $antrianSekarang ? 'K-' . str_pad($antrianSekarang->nomor_antrian, 3, '0', STR_PAD_LEFT) : '-' }}
                                    </span>
                                </div>
                    ...
                    @else
                        ...
                        <p class="text-muted mb-4">Silakan ambil nomor antrian untuk konsultasi kesehatan anak</p>
                        <button class="btn btn-primary btn-lg rounded-pill px-4 py-2">
    ...
    <div class="card border-0 shadow-sm rounded-4 h-100">
        <div class="card-header bg-transparent border-0 py-3">
            <h5 class="fw-semibold mb-0 text-primary">
                <i class="fas fa-baby me-2"></i>Informasi Poli Anak
            </h5>
        </div>
        <div class="card-body">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="fw-semibold">Konsultasi & Pemeriksaan Kesehatan Anak</div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3 border rounded-3 mb-3 hover-card">
                        <div>
                            ...
                            <div class="fw-bold">K-{{ str_pad($antrian->nomor_antrian, 3, '0', STR_PAD_LEFT) }}</div>
                        </div>
                        <div>
                            <span class="badge bg-{{ $antrian->status == 'dipanggil' ? 'warning' : ($antrian->status == 'menunggu' ? 'primary' : 'secondary') }} rounded-pill">
